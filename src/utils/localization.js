const localePacks = {
  'pt-BR': {
    ...
    system: {
      menuLabel: 'Abrir menu do sistema',
      shutdownLabel: 'Desligar PortfolioOS...',
      shutdownTitle: 'Desligar PortfolioOS?',
      shutdownBody:
        'As janelas abertas serao encerradas e a tela vai apagar como um Mac. Voce podera ligar o PortfolioOS novamente quando quiser.',
      cancelAction: 'Cancelar',
      confirmShutdown: 'Desligar',
      bootTitle: 'portfolioOS',
      bootStatus: 'Inicializando ambiente',
      bootHint: 'Carregando desktop, Finder, Safari e os projetos do portfolio...',
      shutdownStatus: 'Encerrando sessao',
      shutdownHint: 'Apagando a tela e finalizando a experiencia atual...',
      poweredOffTitle: 'PortfolioOS desligado',
      poweredOffHint: 'Clique no botao de energia para ligar novamente.',
      powerOnAction: 'Ligar',
    },
    dock: {
  ...
  en: {
    ...
    system: {
      menuLabel: 'Open system menu',
      shutdownLabel: 'Shut Down PortfolioOS...',
      shutdownTitle: 'Shut down PortfolioOS?',
      shutdownBody:
        'Open windows will close and the screen will turn off like a Mac. You can power PortfolioOS back on whenever you want.',
      cancelAction: 'Cancel',
      confirmShutdown: 'Shut Down',
      bootTitle: 'portfolioOS',
      bootStatus: 'Initializing environment',
      bootHint: 'Loading desktop, Finder, Safari, and the portfolio projects...',
      shutdownStatus: 'Ending session',
      shutdownHint: 'Turning off the screen and wrapping up the current experience...',
      poweredOffTitle: 'PortfolioOS is off',
      poweredOffHint: 'Click the power button to start it again.',
      powerOnAction: 'Power On',
    },
    dock: {
  ...
  en: {
    ...
    professionalExperience: [
      ...
      },
      {
        ...
        highlights: [
          'Worked as a Customer Relationship Management Analyst at ASG Educacao.',
          'Remote work in a corporate environment focused on customer relationship operations.',
          'Experience with large companies such as Alpargatas, Danone, Ceva Saude Animal, CMPC, PTC, Sinqia, and Melitta.',
        ],
      },
    ],
    education: [
